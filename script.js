...
// ==========================================================
// AQUI COMEÇA A PARTE QUE FOI MODIFICADA
// ==========================================================
...
// ==========================================================
// AQUI TERMINA A PARTE QUE FOI MODIFICADA
// ==========================================================
...
function displayQuestion() {
    ...
    // Modificação para usar botões simples
    const optionsGrid = document.createElement('div');
    optionsGrid.className = 'options-grid';

    question.options.forEach((option, index) => {
        const button = document.createElement('button');
        button.className = 'option-button-simple'; // Usaremos uma nova classe para estilizar
...
function selectAnswer(option, index) {
    ...
    }, 400); // Tempo de transição um pouco mais rápido
}
...
function displayPerfumeRecommendations() {
    ...
    let filteredPerfumes = perfumeData.filter(perfume => {
        ...
        // Filtro por gênero
        if (userUniverse === 'masculino' && perfume['Gênero'] !== 'Masculino' && perfume['Gênero'] !== 'Versátil') return false;
        if (userUniverse === 'feminino' && perfume['Gênero'] !== 'Feminino' && perfume['Gênero'] !== 'Versátil') return false;
